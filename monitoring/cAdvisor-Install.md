...
**cAdvisor (Container Advisor)** হলো Google-এর তৈরি একটি **কনটেইনার মনিটরিং টুল**, যা মূলত **Docker কনটেইনারের পারফরম্যান্স এবং রিসোর্স ব্যবহার (CPU, Memory, Disk, Network)** ট্র্যাক করে।
